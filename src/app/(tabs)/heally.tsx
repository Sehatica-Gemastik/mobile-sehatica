...
const styles = StyleSheet.create({
  ...
  heallyAvatar: { width: 44, height: 44, borderRadius: 14, alignItems: 'center', justifyContent: 'center', position: 'relative' },
  ...
  heallyName: { fontSize: FontSize.md, fontWeight: '700' },
  heallyStatus: { fontSize: FontSize.xs },
  ...
  tabSwitcher: { flexDirection: 'row', margin: Spacing.sm, marginHorizontal: Spacing.lg, borderRadius: BorderRadius.lg, padding: 3 },
  tabBtn: { flex: 1, paddingVertical: 8, alignItems: 'center', borderRadius: BorderRadius.md },
  tabBtnText: { fontSize: FontSize.xs, fontWeight: '500' },
  ...
  welcomeTitle: { fontSize: FontSize.sm, fontWeight: '700', marginBottom: 4 },
  welcomeText: { fontSize: FontSize.xs, lineHeight: 17 },
  suggestions: { paddingHorizontal: Spacing.base, paddingVertical: 8, gap: 8 },
  suggestionChip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: BorderRadius.lg, borderWidth: 1 },
  ...
  input: { fontSize: FontSize.sm, lineHeight: 20, maxHeight: 96 },
  ...
  waTitle: { fontSize: FontSize.sm, fontWeight: '700' },
  waPhone: { fontSize: FontSize.xs, marginTop: 2 },
  waOnlineDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: '#25D366' },
  waFeature: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  waFeatureIcon: { width: 40, height: 40, borderRadius: 12, alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  waFeatureTitle: { fontSize: FontSize.sm, fontWeight: '600' },
  waFeatureDesc: { fontSize: FontSize.xs, marginTop: 2 },
  waBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 14, borderRadius: BorderRadius.xl },
  waBtnText: { color: 'white', fontWeight: '700', fontSize: FontSize.md },
  waNote: { alignItems: 'center' },
  waNoteText: { fontSize: FontSize.xs, textAlign: 'center' },
});
